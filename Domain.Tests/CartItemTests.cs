...
public class CartItemTests
{
    ...
    [Fact]
    public void DecideUpdateUnitPrice_WithValidPrice_ShouldSucceed()
    {
        // Arrange
        var item = CartItem.ApplyCreate(productId: 101, quantity: 5, unitPrice: 100.00m);

        // Act
        var result = item.DecideUpdateUnitPrice(150.00m);
    ...
    [Fact]
    public void DecideUpdateUnitPrice_WithInvalidPrice_ShouldFail()
    {
        // Arrange
        var item = CartItem.ApplyCreate(productId: 101, quantity: 5, unitPrice: 100.00m);

        // Act
        var result = item.DecideUpdateUnitPrice(0.001m);
    ...
    [Fact]
    public void ApplyUpdateUnitPrice_ShouldUpdatePriceAndTotalPrice()
    {
        // Arrange
        var item = CartItem.ApplyCreate(productId: 101, quantity: 5, unitPrice: 100.00m);

        // Act
        item.ApplyUpdateUnitPrice(150.00m);

        // Assert
        item.UnitPrice.Should().Be(150.00m);
        item.TotalPrice.Should().Be(750.00m);
    }
    ...
    [Fact]
    public void ValidateStock_WithEvenProductIdAndLowQuantity_ShouldSucceed()
    {
        // Arrange
        var item = CartItem.ApplyCreate(productId: 102, quantity: 10, unitPrice: 100.00m);

        // Act
        var result = item.ValidateStock();
    ...
    [Fact]
    public void ValidateStock_WithOddProductIdAndHighQuantity_ShouldFail()
    {
        // Arrange
        var item = CartItem.ApplyCreate(productId: 101, quantity: 51, unitPrice: 100.00m);
    ...
    [Fact]
    public void ValidateStock_WithOddProductIdAndLowQuantity_ShouldSucceed()
    {
        // Arrange
        var item = CartItem.ApplyCreate(productId: 101, quantity: 50, unitPrice: 100.00m);
